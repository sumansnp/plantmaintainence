...
<li><a href="viewCalibrationLogSummaryReport.jsp">View Calibration Log</a></li>
   ...
   <div class="content">
    <h1> Repair Log</h1>
  <p>
    <input type="image" name="etmain" id="etmain" src="imgs/rh.jpg" width=175 height=175   />
  </p>
  <p>It deals with repairs of instruments. The data in this module is generated dynamically based on certain conditions. For example, failure of calibration test more than thrice would lead a to a record being entered in the defective instruments table. </p>
<p>&nbsp;</p>
  </div>
  <div class="footer">
