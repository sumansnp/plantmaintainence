...
<%
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("select distinct iName,cs.iCode,frequencyCalibrationYear,Month(duedate),Month(donedate) from instrumentlist il, calibrationschedule cs left join calibrationlog cl on cs.csno=cl.csno where il.icode=cs.icode and duedate between '"+start+"-04-01' and '"+end+"-03-01'");
 %>
