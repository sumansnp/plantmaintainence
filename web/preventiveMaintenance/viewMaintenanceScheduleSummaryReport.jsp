...
<%
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("select distinct eName,ms.eCode,frequencyMaintenanceMonth,Month(duedate),Month(donedate) from equipmentlist el, maintenanceschedule ms left join maintenancelog ml on ms.sno=ml.sno where el.ecode=ms.ecode");
 %>
