...
<%
        ...
        int start=Integer.parseInt(request.getParameter("year"));
        int end=start+1;
        int cnt=0;
        Connection con = null;
        try {
            ...
            ResultSet rs = stmt.executeQuery("select distinct eName,ms.eCode,frequencyMaintenanceMonth,Month(duedate),Month(donedate),ms.sno from equipmentlist el, maintenanceschedule ms left join maintenancelog ml on ms.sno=ml.sno where el.ecode=ms.ecode and duedate between '"+start+"-04-01' and '"+end+"-03-01'");
 %>
 <p><h1>Maintenance Schedule</h1></p>
 <h5>
 <table width="50%"><tr>
 <td align="left">Duration :- <%=start%>-<%=end%></td><td align="right"><img src="imgs/due2.jpg"> DUE&nbsp;&nbsp;&nbsp;<img src="imgs/done.bmp"> DONE</td></tr>
 </table>
</h5>
 ...
 <%
            ...
            out.println("<th>Name of Equipment</th>");
            out.println("<th>Equipment Code</th>");
            ...
            while (rs.next()) {
                ...
                out.println("<td>"+rs.getString(3)+" months");
