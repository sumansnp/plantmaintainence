...
<title>Repair Log - Delete Defective Instrument</title>
...
<li><a href="viewCalibrationLogSummaryReport.jsp">View Calibration Log</a></li>
   ...
   <div class="content">
    <h1>Delete Defective Instrument</h1>
    <p>&nbsp;</p>
    <c:if test="${pageContext.request.method=='POST'}">
                    <c:catch var="exception">
                        <sql:update var="deleteDefectiveInstrument" dataSource="jdbc/plantmaintenance">
                            DELETE FROM defectiveInstruments
                            WHERE iCode=?
                            <sql:param value="${param.i_code}"/>
                        </sql:update>
                            <c:choose>
                                <c:when test="${deleteDefectiveInstrument>=1}">
    ...
    <form action="" method="post" name="form1" onSubmit="return validate();">
    	<table border=1 align=center width=80%>
        	<tr>
            	<td width="50%">Enter Instrument Code<td width="50%"><input type="text" name="i_code">
