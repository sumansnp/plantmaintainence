...
<li><a href="viewCalibrationLogSummaryReport.jsp">View Calibration Log</a></li>
   ...
   <div class="content">
    <h1>View Repair History</h1>
    <p>&nbsp;</p>
    <form action="viewRepairHistoryReport.jsp" method="post" name="form1" onSubmit="return validate();">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p><a href="viewRepairHistorySummaryReport.jsp">View Repair History for all Instruments</a></p>
  </div>
  <div class="footer">
