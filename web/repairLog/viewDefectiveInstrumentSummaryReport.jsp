...
<title>Repair Log - View Defective Instrument</title>
...
<li><a href="viewCalibrationLogSummaryReport.jsp">View Calibration Log</a></li>
  ...
  <div class="content">
    <h1>Defective Instruments Summary Report</h1>
    <p>&nbsp;</p>
    <font size="2">
        <sql:query var="defectiveInstruments" dataSource="jdbc/plantmaintenance">
            select di.`diNo`,di.`iCode`,il.`iName`,di.`rhNo`,di.`csNo`,di.`clNo` from defectiveInstruments di,instrumentList il
            where di.`iCode`= il.`iCode`
        </sql:query>

         <table border="1" align="center" width="80%">
            <!-- column headers -->
            <tr align="center">
               <th>Defective Instrument No.</th>
            ...
            <!-- column data -->
            <c:forEach var="row" items="${defectiveInstruments.rowsByIndex}">
                <tr align="center">
